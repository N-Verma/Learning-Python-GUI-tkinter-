...
c.pack()
c.create_line(10,10,10,100) // the 4 parameters are taken in pair of 2 from the left side, they represent the coordinate of the 2 end of the line
...
//making oval or circle
c.create_oval(10,10,80,80) //here the parameters represent the coordinates of the end point of the diagonal of the rcetangle in which
                           // the circle is required to be made
mainloop()
